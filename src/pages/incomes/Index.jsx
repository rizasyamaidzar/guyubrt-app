...
const index = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const result = await apiFetch(`/incomes/${id}`, 'DELETE'); // Use the helper
        ...
        <>
            <div className="w-3/4 mx-auto">
                <div className="flex justify-between">
                    <h1 className='font-semibold text-xl my-4'>Pemasukan</h1>
                    <a
                        href="incomes/create"
                ...
                <Table apiUrl={apiUrl} headers={headers} fields={fields} onEdit={handleEdit}
                    onDelete={handleDelete} detailUrl="/incomes/:id" />
            </div>
        </>
    )
}
